        ...
        <div class="row">
            <div class="col-lg-3 my-lg-0 my-md-1">
                <div id="sidebar" class="bg-purple">
                    ...
                    <ul>
                      <li> <a href="profilesearch" class="text-decoration-none d-flex align-items-start">
                        ...
                        <li class="active"> <a href="profileedit" class="text-decoration-none d-flex align-items-start">
                            ...
                            <li> <a href="logout" class="text-decoration-none d-flex align-items-start">
