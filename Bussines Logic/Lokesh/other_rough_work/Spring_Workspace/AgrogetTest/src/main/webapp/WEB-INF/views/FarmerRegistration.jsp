                  ...
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li class="has-sub">
                              ...
                              <ul class="sub-menu">
                                  <li><a href="FarmerRegistration.html" class="active">As Farmer</a></li>
            ...
            <div class="col-lg-12 setborder">
              <form id="contact" action="loginFarmer" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <fieldset>
                      <input name="PinCode" type="number" id="pin" placeholder="Pincode" required="">
                    </fieldset>
                  </div>
                  ...
                  <div class="col-lg-5">
                    <fieldset class="height"><label for="files" class="btn">Upload Kisan Card</label>
                      <input id="files" style="visibility:hidden;" type="file" required="">
                    </fieldset>
                  </div>
