...
%>
			...
			<td><a href="/home/givefeedback">Give Feedback</a></td>
			<td><a href="/home/enterfeedback?equipmentid=<%=orderEquipment.getEquipmentInfoTbl().getEquipment_id() %>"> Enter Equipment Feedback</a></td>
