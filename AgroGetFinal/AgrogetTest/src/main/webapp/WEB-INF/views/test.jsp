                ...
                <div class="row">
                  <div class="col-lg-12" style=text-align:center>
                    ...
                    <hr>
                 	...
                 	<h6>Order #<%=oit.getOrderId() %></h6>
                 	<h6>Total Cost <%=oit.getOrderTotalCost() %></h6>
                 		<h6>Your Order Successfully Booked</h6>
                 		
                 		 <a href="farmerprofile?farmerid=<%=farmerEntity.getFarmerId() %>" style="margin-left:752px;" target="_blank">Go To Profile</a>
                </div>
              </form>
            </div>
          </div>
