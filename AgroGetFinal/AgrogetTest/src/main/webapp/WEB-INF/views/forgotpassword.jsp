...
<body>
  ...
  <section class="heading-page header-text" id="top">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h2> Enter Your Registered EmailId</h2>
              ...
              <form id="contact" action="" method="post">
                ...
                <!--toggle switch-->
                  ...
                  <div class="col-lg-12">
                    ...
                    <fieldset>
                      <input name="Email Id" type="email" id="email" placeholder="Email Id" required="">
                    </fieldset>
                  </div>
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                        <a href="login" class="btn btn-secondary btn-lg active pass" role="button" aria-pressed="true">Send Email</a>
