                ...
                <div class="affix">
                    <div id="sidebar" class="bg-purple">
                        ...
                        <ul>
                            ...
                            <li> <a href="Profile.html" class="text-decoration-none d-flex align-items-start">
                                    <div class="fas fa-box pt-2 me-3"></div>
                                    <div class="d-flex flex-column">
                                        <div class="link">My Account</div>
                                        <div class="link-desc">View Your Details</div>
                                    </div>
                                </a> </li>
                            <li> <a href="ProfileMyOrders.html" class="text-decoration-none d-flex align-items-start">
                                    <div class="fas fa-box-open pt-2 me-3"></div>
                                    <div class="d-flex flex-column">
                                        <div class="link">My Bookings</div>
                            ...
                            <div class="col-lg-12 align-self-center">
                                <div class="row">
                                    <div class="col-lg-12 setborder">
                                        <form id="contact" action="conformorder" method="post">
                                     <%--    <% if (equipment.getEquipment_rate_type().equals("day"))
	{
	%> --%>
                                            <div class="row">
                                                <div class="col-lg-12 ">
                                                    <h2 style="text-align-last: center;">Order Details</h2>
                                                </div>
                                                ...
                                                <div class="order my-3 bg-light">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <h5><Span><%=equipment.getEquipment_name() %></Span></h5>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <h5><Span><%=equipment.getEquipment_type() %></Span></h5>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-lg-9">
                                                            <h5> Equipment Rate Type :</h5>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <h5><Span><%=equipment.getEquipment_rate_type() %> </Span></h5>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <h5> Equipment Rate :</h5>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <h5><Span><%=equipment.getEquipment_rate() %> </Span></h5>
                                                        </div>
                                                    </div>
                                                ...
                                                <%--  <%}else
  {
	%> --%>
                                                ...
                                                <div class="col-lg-6">
                                                    <fieldset>
                                                        From Time
                                                        <input name="fromtime" type="number" id="fromtime"
                                                          min="1" max="24"  placeholder="From Time" required="">
                                                    </fieldset>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <fieldset>
                                                        To Time
                                                        <input name="totime" type="number" id="totime" placeholder="To Time"
								...
								<input type="hidden" value=<%=farmerEntity.getFarmerId()%> name="farmerid" id="farmerid"   />	
                                                ...
                                                <div class="col-lg-12">
                                                    <fieldset>
                                                        <div>
                                                            <button type="submit" id="form-submit" class="button">Order
                                                                Now</button>
                                                    </fieldset>
