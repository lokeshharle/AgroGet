        ...
        <div class="col-lg-6 align-self-center">
          <div class="row">
            <div class="col-lg-12 setborder">
              <form id="contact" action="/resetpassword2" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    ...
                    <fieldset>
                     <input type="text" id="username" name="username" placeholder="Enter Email" required=""></input>
                    </fieldset>
                  </div>
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      ...
                      <input type="text" id="password" name="password" placeholder="New Password" required=""></input>
                    </fieldset>
                  </div>
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <button type="submit" id="form-submit" class="button log">Reset</button>
                    </fieldset>
                  </div>
                  <br>
