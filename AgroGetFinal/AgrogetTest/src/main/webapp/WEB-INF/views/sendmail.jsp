            ...
            <div class="col-lg-12 setborder">
              <form id="contact" action="/sendmail" method="post">
                ...
                <!--toggle switch-->
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                       <!--  <a href="sendmail" class="btn btn-secondary btn-lg active pass" role="button" aria-pressed="true">Submit</a> -->
                        
                         <button type="submit" id="form-submit" class="button log">Submit</button>
