                        ...
                        <div class="col-lg-12 ">
                          <div class="row">
                            <div class="col-lg-12 setborder">
                              <form id="contact" action="uprenter" method="post">
                                <div class="row">
                                  <div class="col-lg-12 ">
                                    <h2>Edit Profile</h2>
                                  </div>
                                  <div class="col-lg-4">
                                    <fieldset>
                                      <input name="fname" value=<%=renterEntity.getRenterFname()  %> type="text" id="fname" placeholder="FirstName" required="">
                                    </fieldset>
                                  </div>
                                  <div class="col-lg-4">
                                    <fieldset>
                                      <input name="lname" value=<%=renterEntity.getRenterLname() %> type="text" id="lname" placeholder="LastName" required="">
                                    </fieldset>
                                  </div>
                                  <div class="col-lg-4">
                                    <fieldset>
                                      <input name="email" value=<%=renterEntity.getRenterEmail() %>  type="text" id="email" pattern="[^ @]*@[^ @]*" placeholder="Email"
                                        required="">
                                    </fieldset>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset>
                                      <input name="password" value=<%=renterEntity.getRenterPassword() %> value=<%=renterEntity.getRenterId() %> type="password" id="password" placeholder="Password" required="">
                                    </fieldset>
                                  </div>
                                  ...
                                  <div class="col-lg-4">
                                    <fieldset>
                                      <input name="mobile" value=<%=renterEntity.getRenterMobile() %>  type="number" id="name" placeholder="Phone" required="">
                                    </fieldset>
                                  </div>
                
                                  <div class="col-lg-4">
                                    <fieldset>
                                      <input name="address" value=<%=renterEntity.getRenterAddress() %>  type="text" id="address" placeholder="Address" required="">
                                    </fieldset>
                                  </div>
                
                                  <div class="col-lg-4">
                                    <fieldset>
                                      <input name="ShopDetails" value=<%=renterEntity.getRenterShopDetails() %>  type="text" id="pin" placeholder="ShopDetails" required="">
                                    </fieldset>
                                  </div>
