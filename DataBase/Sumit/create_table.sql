...
create table image_info_tbl(image_id int not null auto_increment,
farmer_id int,renter_id int,equipment_id int, image_data longblob,
...
use agroget;
alter table equipment_info_tbl modify equipment_rate double;
use agroget;
delete from image_info_tbl where image_id=38;
